...
export const PaceportSummaryCard = ({ countryName, routes, currentStamps, onUnlock }: PaceportSummaryCardProps) => {
  ...
  return (
    <section className="relative z-20 rounded-t-[34px] border-t border-white/75 bg-[linear-gradient(180deg,rgba(250,249,245,0.97)_0%,rgba(245,243,238,0.99)_100%)] px-6 pb-8 pt-4 shadow-[0_-16px_34px_rgba(34,49,38,0.08)] backdrop-blur-2xl">
