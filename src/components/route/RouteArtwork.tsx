...
> = {
  ...
  "paris-eiffel-route": {
    glow: "from-rose-100/80 to-lime-100/30",
    accent: "bg-rose-500"
  },
  "mount-fuji-route": {
    glow: "from-sky-100/80 to-rose-100/30",
    accent: "bg-sky-500"
  },
  "aurora-harbor-route": {
...
export const RouteArtwork = ({
  ...
  const simulationZoomOffset = useMemo(() => {
    ...
    if (routeId === "mount-fuji-route") {
      return 0.55;
    }

    if (routeId === "aurora-harbor-route") {
      return 0.35;
    }
